...
const defaultCardData = [
  ...
  { color: '#120F17', title: 'Entries', description: 'People entered', label: 'Entry' },
  { color: '#120F17', title: 'Exits', description: 'People left', label: 'Exit' },
  { color: '#120F17', title: 'Inside', description: 'Currently inside', label: 'Occupancy' },
  { color: '#120F17', title: 'Status', description: 'System status', label: 'Live' }
];
...
const MagicBento = ({
  ...
  const cardData = customCardData || defaultCardData;
